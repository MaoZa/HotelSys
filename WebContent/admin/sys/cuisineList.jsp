		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="${pageContext.request.contextPath }/admin/sys/style/images/title_arrow.gif" /> 菜系列表
			</div>
		</div>
			...
			<tbody id="TableData">
				...
				<c:forEach items="${AllCategory }" var="category">			
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath }/admin/updateCuisine?id=${category.id }" class="FunctionButton">更新</a> 
							<a href="${pageContext.request.contextPath }/admin/deleteCuisine?id=${category.id }" class="FunctionButton">删除</a>
						</td>
					</tr>
				</c:forEach>	
