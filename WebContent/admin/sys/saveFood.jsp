...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="${pageContext.request.contextPath }/admin/sys/style/images/title_arrow.gif"/> 添加新菜品
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/admin/SaveFoodtrue" method="get">
		<!-- 本段标题（分段标题） -->
