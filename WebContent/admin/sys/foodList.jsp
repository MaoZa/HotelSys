...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath }/admin/sys/style/images/title_arrow.gif"/> 菜品列表
		</div>
    </div>
        ...
        <tbody id="TableData">
			...
			<c:forEach items="${AllFood }" var="Food">
				<tr class="TableDetail1">
	                ...
	                <td>${Food.vipprice }&nbsp;</td>
					<td>
						<a href="${pageContext.request.contextPath }/admin/updateFood?foodid=${Food.id }"  class="FunctionButton">更新</a>				
						<a href="${pageContext.request.contextPath }/admin/deleteFood?id=${Food.id }" onClick="return delConfirm();"class="FunctionButton">删除</a>				
					</td>
				</tr>
        	</c:forEach>
