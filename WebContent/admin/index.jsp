...
<title>无线点餐后台管理</title>
	...
	<frameset rows="100px,*,19px" framespacing="0" border="0" frameborder="0">
		<frame src="sys/top.html" scrolling="no" noresize /> 
		<frameset cols="178px,*">
			<frame noresize src="sys/left.html" scrolling="yes" /> 
			<frame noresize name="right" src="sys/right.html" scrolling="yes" /> 
		</frameset>
		<frame noresize name="status_bar" scrolling="no" src="sys/bottom.html" />
	</frameset>
	<noframes>
		<body>
